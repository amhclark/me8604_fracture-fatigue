...
yield_strength = 10e6 * yield_strength_MPa; 
...
sigma_1_MPa = (principal_stresses(3))*10e-6;            % Principal stress definition based on common practice nomenclature
sigma_2_MPa = (principal_stresses(1))*10e-6;
sigma_3_MPa = (principal_stresses(2))*10e-6;
...
s_g_torsion = ((2*torque)/(pi*radius^3))*10e-6; % MPa
...
torsion_yield = yield_strength/sqrt(3); 
...
fprintf(output_file_part_II, ['Fracture Toughness I ', formatSpec, '\n'], k_Ic);
fprintf(output_file_part_II, ['Fracture Toughness III ', formatSpec, '\n'], k_IIIc);
fprintf(output_file_part_II, ['Safety Factor Yielding ', formatSpec, '\n'], safety_factor_yielding_design);
fprintf(output_file_part_II, ['Safety Factor Fracture I ', formatSpec, '\n'], safety_factor_fracture_I_design);
fprintf(output_file_part_II, ['Safety Factor Fracture III ', formatSpec, '\n'], safety_factor_fracture_III_design);
...
fprintf(output_file_part_II, ['Fracture Toughness (Axial) ', formatSpec, '\n'], k_axial);
fprintf(output_file_part_II, ['Fracture Toughness (Bending) ', formatSpec, '\n'], k_bending);
fprintf(output_file_part_II, ['Fracture Toughness (Torsion) ', formatSpec, '\n'], k_torsion);
fprintf(output_file_part_II, ['Fracture Toughness (Mode I) ', formatSpec, '\n'], k_I);
fprintf(output_file_part_II, ['Fracture Toughness (Mode III) ', formatSpec, '\n'], k_III);
fprintf(output_file_part_II, ['Torsion Yield Strength ', formatSpec, '\n'], torsion_yield);
fprintf(output_file_part_II, ['Plastic Stress (Axial) ', formatSpec, '\n'], plastic_force);
fprintf(output_file_part_II, ['Plastic Stress (Bending) ', formatSpec, '\n'], plastic_moment);
fprintf(output_file_part_II, ['Plastic Stress (Torsion) ', formatSpec, '\n'], plastic_torque);
