...
% Input Data Unit Conversion (MPa to Pa to ensure consistent units)
...
% LEFM Check
LEFM_kI = (4/pi)*(k_I/yield_strength)^2;
LEFM_kIII = (4/pi)*(k_III/yield_strength)^2;
...
% Plane Strain Check
PS_kI = 2.5*(k_I/yield_strength)^2;
PS_kIII = 2.5*(k_III/yield_strength)^2;
